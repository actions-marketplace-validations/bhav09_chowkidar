...
def format_purpose_classification_prompt(payload: dict) -> str:
    return PURPOSE_CLASSIFICATION_PROMPT.format(payload_json=json.dumps(payload, indent=2))


def parse_purpose_classification_response(response: str) -> list[dict[str, str]] | None:
    """Parse SLM purpose classification JSON into a list of dicts."""
    from ..cloud_connectors import parse_classification_response
